          ...
          <form id="operationForm" method="post" action="{{ $activeUrl }}" autocomplete="off" class="form-horizontal">
            ...
            <div class="card">
              ...
              <div class="card-body">
               ...
               <div class="row error text-danger pl-3" >
               ...
               @endif
                  ...
                  <div class="col-sm-7">
                    <div class="form-group bmd-form-group">
                       <select name="platform_id" id="platform_id" class="form-control" required aria-required="true">
                            ...
                            <option value="{{ $platformKey }}" @if( old('platform_id', '') == $platformKey) selected @endif>{{ $platformValue }}</option>
                            @endforeach
                       </select>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="rate" id="rate" type="text" placeholder="{{ __('custom.admin.placeholder.rateActivity') }}" value="{{ old('rate', '') }}" required aria-required="true" minlength="1"  maxlength="1000">
                       @if ($errors->has('rate'))
