                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="name" id="name" type="text" placeholder="{{ __('custom.admin.placeholder.roleName') }}" value="{{ old('name', '') }}" required aria-required="true" maxlength="20">
                       @if ($errors->has('name'))
