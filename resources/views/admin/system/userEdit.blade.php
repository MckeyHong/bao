          ...
          <form id="operationForm" method="post" action="{{ $activeUrl . '/'. $detail['id'] }}" autocomplete="off" class="form-horizontal">
            ...
            <div class="card">
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label" for="account">{{ __('custom.admin.form.systemUser.account') }}</label>
                  <div class="col-sm-7">
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label" for="password">
                    {{ __('custom.admin.form.systemUser.password') }}
                  </label>
                  <div class="col-sm-7">
                    <div class="form-group bmd-form-group">
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label" for="password_confirmation">
                    {{ __('custom.admin.form.systemUser.password_confirmation') }}
                  </label>
                  <div class="col-sm-7">
                    <div class="form-group bmd-form-group">
