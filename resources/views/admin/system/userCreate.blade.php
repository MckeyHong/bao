              ...
              <div class="card-body ">
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label" for="account">
                    <span class="text-danger">*</span>{{ trans('custom.admin.form.systemUser.account') }}
                  </label>
                  <div class="col-sm-7">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="account" id="account" type="text" placeholder="{{ trans('custom.admin.placeholder.account') }}" value="{{ old('account', '') }}" required aria-required="true" minlength="4" maxlength="30">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="name" id="name" type="text" placeholder="{{ trans('custom.admin.placeholder.name') }}" value="{{ old('name', '') }}" required aria-required="true" maxlength="30">
                       @if ($errors->has('name'))
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label" for="password">
                    <span class="text-danger">*</span>{{ trans('custom.admin.form.systemUser.password') }}
                  </label>
                  <div class="col-sm-7">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" type="password" name="password" id="password" placeholder="{{ trans('custom.admin.placeholder.password') }}" value="" required minlength="6" maxlength="20">
                ...
                <div class="row">
                  <label class="col-sm-2 col-form-label" for="password_confirmation">
                    <span class="text-danger">*</span>{{ trans('custom.admin.form.systemUser.password_confirmation') }}
                  </label>
                  <div class="col-sm-7">
                    <div class="form-group bmd-form-group">
                      <input class="form-control" name="password_confirmation" id="password_confirmation" type="password" placeholder="{{ trans('custom.admin.placeholder.password_confirmation') }}" value="" required minlength="6" maxlength="20">
                    </div>
                  </div>
                </div>
                <div class="row">
